...
# 2026.07.16 - v. 1.0 - rename from sprawdz-czy-dziala-strona-www.ontsolutions.com.sh; add -h/-v/--no_startup_delay
...
#
# healthchecks-site-ontsolutions-com-up.sh
#
# HTTP check www.ontsolutions.com; ping Healthchecks on success or fail.
#
