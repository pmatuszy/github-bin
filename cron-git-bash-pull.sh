...
Cron wrapper: run ${profile_location_dir:-$HOME}/github/github-bash_profile/git-pull.sh batch,
...
HC_message=$("${profile_location_dir:-$HOME}/github/github-bash_profile/git-pull.sh" batch 2>&1 ; exit $?)
return_code=$?
