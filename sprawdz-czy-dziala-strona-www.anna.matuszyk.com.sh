...
export URL="www.anna.matuszyk.com"  ; export URL
blad=1
how_many_retries=10
retry_delay=15
...
*/15 * * * *  /usr/bin/flock --nonblock --exclusive /root/bin/sprawdz-czy-dziala-strona-www.anna.matuszyk.com.sh -c /root/bin/sprawdz-czy-dziala-strona-www.anna.matuszyk.com.sh
