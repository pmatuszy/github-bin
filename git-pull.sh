...
if [ "${p}" == 'y' -o  "${p}" == 'y' ]; then
  ...
  echo git ls-remote git+ssh://git@github.com/pmatuszy/github-bin.git | boxes -s 80x5 -a c
  ...
  echo git pull git+ssh://git@github.com/pmatuszy/github-bin.git | boxes -s 80x5 -a c
