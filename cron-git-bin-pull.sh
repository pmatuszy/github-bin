...
Cron wrapper: run ${profile_location_dir:-$HOME}/github/github-bin/git-pull.sh batch, optionally report exit code
...
HC_message=$("${profile_location_dir:-$HOME}/github/github-bin/git-pull.sh" batch 2>&1 ; exit $?)
return_code=$?
