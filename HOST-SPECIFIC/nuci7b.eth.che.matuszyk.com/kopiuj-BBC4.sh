...
Operational script (copy_backup-BBC4).
...
export SOURCE_DIR="/worek-samba/nagrania/BBC4"
export DEST="/mnt/luks-raid1-A/video-1dyne-kopie/BBC4-ARCHIWUM"
...
file_count=$(ssh "${SOURCE_HOST}" "cd ${SOURCE_DIR} ; /bin/ls -1tr" | wc -l)
