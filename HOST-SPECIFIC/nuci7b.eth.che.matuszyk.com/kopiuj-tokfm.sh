...
Operational script (copy_backup-tokfm).
...
export SOURCE_DIR="/worek-samba/nagrania/TokFM-nagrania"
export DEST="/mnt/luks-raid1-A/video-1dyne-kopie/TokFM-nagrania-ARCHIWUM"
