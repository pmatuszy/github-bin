...
# w dniu 21.01.2021 dodalem 2>/dev/null na koncu kazdego find'a by nie dostawac co jakis czas maili, ze plik nie istnieje z cronta
...
find /podsync-hdd/ -type d ! -perm 750       -exec chmod 750 -v {} \;                                                 2>/dev/null
find /podsync-hdd/ -type d ! -group www-data -exec chgrp www-data -v {} \;                                            2>/dev/null
