...
export RESTIC_REPOSITORY=rclone:crypt-sftp-SS-ext-backupA:/yt2podcast.eth.che.matuszyk.com

export RCLONE_CONFIG=/root/rclone.conf

MY_EXCLUDES='{/dev,/media,/mnt,/proc,/run,/sys,/tmp,/var/tmp,/veracrypt.vc,/encrypted.luks2,/rclone-jail,$XDG_CACHE_HOME,/root/.cache,/podsync-hdd/_montowanie,/podsync-hdd/_Mikey,/podsync-hdd,/snap/**/*}'
