#!/bin/bash
# 2026.07.16 - v. 0.2 - rename from sprawdz-czy-dziala-litecoincash-daemon.sh; add -h/-v/--no_startup_delay
# 2023.01.24 - v. 0.1 - initial release
#
# healthchecks-litecoincash-daemon-is-running.sh
#
# Check litecoincashd process; ping Healthchecks fail when daemon is down.
#
...
0 7-22 * * * /root/bin/healthchecks-litecoincash-daemon-is-running.sh --no_startup_delay
