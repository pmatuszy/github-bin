...
export URL="https://www.intel.com/content/www/us/en/download/743891/bios-update-dnkbli7v.html?wapkw=dnkbli7v"
temat_maila="(`date '+%Y.%m.%d %H:%M'`) nuci7 BIOS updates"
