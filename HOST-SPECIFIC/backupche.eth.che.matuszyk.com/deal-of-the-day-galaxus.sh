...
/opt/signal-cli/bin/signal-cli -U +41763691467 send -m "(`date '+%Y.%m.%d %H:%M'`) Galaxus.ch-Deal of the Day, https://www.galaxus.ch/en/LiveShopping" -a "${plik_po_cropie}" --note-to-self 2>/dev/null
